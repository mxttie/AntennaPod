 ...
 */
public class LocalFeedViewActivity extends ActionBarActivity {

    private static final String TAG = "LocalFeedViewActivity";
        ...
        public void update(EventDistributor eventDistributor, Integer arg) {
            if ((arg & EventDistributor.FEED_LIST_UPDATE) != 0) {
                updater = Observable.defer(() -> Observable.just(DBReader.getFeedList()))
                        ...
                        .subscribe(feeds -> {
                                    LocalFeedViewActivity.this.feeds = feeds;
                        ...
                        if (!status.isCancelled()) {
                            if (status.isSuccessful()) {
                                ...
                                if (!isFinishing() && !isPaused) {
                                    dialog = new FeedViewAuthenticationDialog(LocalFeedViewActivity.this,
                                            R.string.authentication_notification_title, downloader.getDownloadRequest().getSource());
                                    dialog.show();
                                }
                            } else {
                                String errorMsg = status.getReason().getErrorString(LocalFeedViewActivity.this);
            ...
            public void call(Subscriber<? super FeedHandlerResult> subscriber) {
                ...
                .subscribe(result -> {
                    ...
                    String errorMsg = DownloadError.ERROR_PARSER_EXCEPTION.getErrorString(
                            LocalFeedViewActivity.this) + " (" + error.getMessage() + ")";
                    showErrorDialog(errorMsg);
                });
    }
    ...
    private void showFeedInformation(final Feed feed, Map<String, String> alternateFeedUrls) {
        ...
        subscribeButton.setOnClickListener(v -> {
            try {
                ...
                e.printStackTrace();
                DownloadRequestErrorDialogCreator.newRequestErrorDialog(LocalFeedViewActivity.this,
                        e.getMessage());
            }
            setSubscribeButtonState(feed);
        });
    ...
    private void showFeedDiscoveryDialog(File feedFile, String baseUrl) {
        ...
        final ArrayAdapter<String> adapter = new ArrayAdapter<>(LocalFeedViewActivity.this, R.layout.ellipsize_start_listitem, R.id.txtvTitle, titles);
        ...
        AlertDialog.Builder ab = new AlertDialog.Builder(LocalFeedViewActivity.this)
